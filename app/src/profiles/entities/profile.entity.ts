...
export class Profile {
    ...
    @Column({nullable: true, length: 20, comment:'National Identification Number'})
    public nin_num: string;

    @Column({nullable: true, type: 'date', comment:'National Identification card issued date'})
    public nin_card_issued_date: Date;

    @Column({nullable: true,  comment:'National Identification card issued place'})
